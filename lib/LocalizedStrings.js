...
var LocalizedStrings = function () {
  ...
  _createClass(LocalizedStrings, [{
    ...
    value: function setContent(props) {
      ...
      var shouldSetLanguage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    ...
    value: function setLanguage(language) {
      ...
      var loadLanguage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

      // Check if exists a translation for the current language or if the default
      // should be used
      var bestLanguage = utils.getBestMatchingLanguage(language, this._props, loadLanguage ? this._opts.loadLanguage : null);
